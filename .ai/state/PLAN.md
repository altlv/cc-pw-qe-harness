...
| #   | Gap                                                                                                                                                                                                                         | Why it is not yet done                                                                                                                                |
| --- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| H0  | **Detection precision is measured on one real page only.** Scanning a live site found three confident false positives — two occlusion, one hover — all now fixed and regression-tested. Nobody has measured how many remain | The page-mutation harness in H1 is the same instrument; until it exists, precision is anecdote                                                        |
