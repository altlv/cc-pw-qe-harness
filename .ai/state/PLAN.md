...
This commit is one of three that landed together. The numbers are quoted in the last of
them, from `npm run plan:facts`, which refuses any run older than the code.
